...
let weatherData = [{ day: "current" }, { day: 0 }, { day: 1 }, { day: 2 }, { day: 3 }, { day: 4 }, { day: 5 }, { day: 6 }, { day: 7 }];
...
// disable geolocation because of missing Google API key
...
// Default to Stockholm on page load
getWeatherData("Stockholm");

async function coordinatesToLocationName(coordinates) {
  // Had to remove Google API key because the free trial ran out
  const APIKey = "";
